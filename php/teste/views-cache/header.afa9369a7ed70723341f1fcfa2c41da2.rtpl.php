...
<head>
    ...
    <link href="../../res/assets/css/lib/vector-map/jqvmap.min.css" rel="stylesheet">

    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>

    <!-- <script type="text/javascript" src="https://cdn.jsdelivr.net/html5shiv/3.7.3/html5shiv.min.js"></script> -->
<style type="text/css">
.clearflix::before,  .clearflix::after {
    content: '';
    display: table;
}
.clearflix::after {
...
.card:hover{
    /*8px 11px 20px 0px*/
    box-shadow: 4px 4px 20px 0px  rgba(0,0,10,.5);
    transition: .8s;
}
.disabled {
    pointer-events: none;
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin"><i class="fa fa-drupal" ></i></a> 
                <a class="navbar-brand hidden" href="/admin"><i style="max-width:90px !important;" class="fa fa-drupal" ></i></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li><a href="/admin/list"><i class="menu-icon fa fa-user"></i>Listagem</a></li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="../../res/images/admin.png" alt="User Avatar">
                        </a>
