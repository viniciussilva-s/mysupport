                ...
                <div class="page-header float-right">
                  <div class="page-title">
                    ...
                    <ol class="breadcrumb text-right">
                      ...
                      <li class="active"><a href="/admin/clients">Clients</a></li>
                    </ol>
                  </div>
                </div>
              </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                   ...
                   <tr>
                    ...
                    <td><?php echo htmlspecialchars( $value1["desphone"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo formatDate($value1["dtnasc"]); ?></td>
                    <td><?php if( $value1["indesaddress"] == 1 ){ ?><i class="fa fa-motorcycle" style="color:#2980b9;"></i><?php }else{ ?>Não<?php } ?></td>
                    <td>  
                      <a href="/admin/clients/<?php echo htmlspecialchars( $value1["idclient"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                      <a href="/admin/clients/<?php echo htmlspecialchars( $value1["idclient"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
